  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="parallax-back absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{
        ...
        <div className="animate-fog absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30" />
        <div
          className="animate-fog absolute inset-0 bg-gradient-to-b from-transparent via-black/20 to-transparent"
          style={{ animationDelay: "30s", animationDuration: "120s" }}
        />

        {/* Subtle dark teal glow from bottom */}
        <div className="absolute bottom-0 left-1/2 h-[70%] w-[150%] -translate-x-1/2 transform">
        ...
        <div className="absolute bottom-0 left-0 h-32 w-full overflow-hidden">
          {/* Base fire glow */}
          <motion.div
            className="absolute bottom-0 left-1/4 h-20 w-24 rounded-full bg-gradient-to-t from-blue-600/60 via-purple-500/40 to-transparent blur-sm"
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.6, 0.8, 0.6],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-0 right-1/3 h-16 w-20 rounded-full bg-gradient-to-t from-indigo-600/50 via-blue-500/30 to-transparent blur-sm"
            animate={{
              scale: [1.1, 0.9, 1.1],
              opacity: [0.5, 0.7, 0.5],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-0 left-2/3 h-14 w-16 rounded-full bg-gradient-to-t from-purple-600/40 via-indigo-400/25 to-transparent blur-sm"
            animate={{
              scale: [0.8, 1.3, 0.8],
              opacity: [0.4, 0.6, 0.4],
            }}
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1/3">
          ...
          <div className="animate-walk-left absolute bottom-0 left-[15%] h-48 w-32" />
          <div
            className="animate-walk-center absolute bottom-0 left-[30%] h-56 w-32"
            style={{ animationDelay: "5s" }}
          />

          {/* Center figure */}
          <div className="animate-sway absolute bottom-0 left-[50%] h-60 w-32 -translate-x-1/2 transform" />

          {/* Right figures subtle movement */}
          <div
            className="animate-walk-center absolute bottom-0 right-[30%] h-56 w-32"
            style={{ animationDelay: "8s" }}
          />
          <div className="animate-walk-right absolute bottom-0 right-[15%] h-48 w-32" />
        </div>
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 6px rgba(147, 197, 253, 0.8), 0 0 12px rgba(165, 180, 252, 0.4)",
              }}
              animate={{
                y: [0, -400, -800],
